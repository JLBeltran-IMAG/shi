...
GevGetCameraList.argtypes = [ ctypes.POINTER(GEV_CAMERA_INFO), ctypes.c_int, ctypes.POINTER(ctypes.c_uint32) ]
...
GevOpenCamera.argtypes = [ ctypes.POINTER(GEV_CAMERA_INFO), ctypes.c_uint32, ctypes.c_void_p ]
...
GevGetCameraInterfaceOptions.argtypes = [ ctypes.c_void_p, ctypes.POINTER(GEV_CAMERA_OPTIONS) ]
...
GevSetCameraInterfaceOptions.argtypes = [ ctypes.c_void_p, ctypes.POINTER(GEV_CAMERA_OPTIONS) ]
GevSetCameraInterfaceOptions.restype = ctypes.c_int

# GENAPI Feature types (numeric)
...
GevGetFeatureValue.argtypes = [ ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_int), ctypes.c_int, ctypes.c_void_p ]
...
GevSetFeatureValue.argtypes = [ ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int, ctypes.c_void_p ]
...
GevGetFeatureValueAsString.argtypes = [ ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_int), ctypes.c_int, ctypes.c_char_p ]
...
GevSetFeatureValueAsString.argtypes = [ ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p ]
...
GevInitializeTransfer.argtypes = [ ctypes.c_void_p, ctypes.c_uint32, ctypes.c_uint64, ctypes.c_uint32, ctypes.c_void_p ]
...
GevGetPayloadParameters.argtypes = [ ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint64), ctypes.POINTER(ctypes.c_uint32) ]
...
GevWaitForNextFrame.argtypes = [ ctypes.c_void_p, ctypes.POINTER( ctypes.POINTER(GEV_BUFFER_OBJECT)) , ctypes.c_uint32 ]
...
GevQueryTransferStatus.argtypes = [ ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32) ]
...
# BOOL GevIsPixelTypeYUV( UINT32 pixelType);
#
GevIsPixelTypeYUV = gevlib_lib.GevIsPixelTypeYUV
GevIsPixelTypeYUV.argtypes = [ ctypes.c_uint32 ]
GevIsPixelTypeYUV.restype = ctypes.c_int
...
# BOOL GevIsPixelTypeBiColor (UINT32 pixelType);
#
GevIsPixelTypeBiColor = gevlib_lib.GevIsPixelTypeBiColor
GevIsPixelTypeBiColor.argtypes = [ ctypes.c_uint32 ]
GevIsPixelTypeBiColor.restype = ctypes.c_int
...
GevRegisterEventCallback.argtypes = [ ctypes.c_void_p, ctypes.c_uint32 , ctypes.c_void_p, ctypes.c_void_p ]
